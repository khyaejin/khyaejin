...
- **Backend Development (Core)**: Spring Boot · Spring Data JPA · MySQL  
- **Programming & Data**: Java · Python(FastAPI)  
- **Infra & DevOps**: Docker · Docker Compose · Nginx · AWS(EC2, S3, RDS)  
- **CI/CD & Deployment**: GitHub Actions 기반 자동화 파이프라인 구축 및 운영 경험  
- **API & Security**: Swagger · JWT 기반 인증/인가 · OAuth2 소셜 로그인(Kakao, Naver, Google, GitHub)  
- **External APIs & Integration**: 지도/번역 · 공공데이터 · GitHub API 등 다양한 연동 경험  
...
- **학부연구생 (2025.09 ~ )**  
  - 지능형 자율이동체 구현을 위한 **LLM/VLM 개발** 연구 참여  
...
<div align="center">
  ...
  <h3>📄 AI·대시보드 기반 개발자 문서 자동화 플랫폼(PND)</h3>
  <p align="center">
